 ...
 *
 */
class Done_Bonus_Block_Adminhtml_Promo_Quote_Edit_Tab_Main extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Main {
    ...
    protected function _prepareForm()
    {
        ...
        /** add custom field for b2b stores
         * this is use for only to show bar in front in in customer section
         */
         $fieldset->addField('store_views', 'multiselect', array(
                'name'      => 'store_views[]',
                'label'     => Mage::helper('salesrule')->__('Customer Store Views'),
                'title'     => Mage::helper('salesrule')->__('Customer Store Views'),
                'required'  => true,
                'values'    => Mage::getModel('bonus/system_config_source_store')->toOptionArray(),
        ));
